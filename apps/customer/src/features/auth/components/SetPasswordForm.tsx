...
import { requestPasswordOtp, setPassword } from "../api";
...
/**
 * Every migrated customer arrives here: the legacy password went out in plain
 * text by SMS, so v2 forces a replacement on first login (D-045).
 */
